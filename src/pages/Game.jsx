        ...
        <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-4 max-w-lg w-full border border-white/20">
          <div className="text-center mb-10">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-linear-to-br rounded-2xl mb-6 shadow-lg">
              <img src="https://theoaisys.com/sites/default/files/Group%201%20%282%29.png" alt="" className='w-15 h-15' />
            </div>
            <h1 className="text-4xl font-bold bg-linear-to-r from-[#CC1111] to-[#E62222] bg-clip-text text-transparent mb-3">
              Oaisys Quiz
            </h1>
            <p className="text-slate-600 text-lg">Can you name them all in 30 seconds?</p>
          </div>
            ...
            <div className="h-3 bg-slate-800 rounded-full overflow-hidden shadow-inner">
              <div 
                className={`h-full transition-all duration-1000 ${
                  timeLeft <= 10 ? 'bg-linear-to-r from-red-500 to-[#CC1111]' : 'bg-linear-to-r from-[#CC1111] to-[#E62222]'
                }`}
          ...
          <div className="flex justify-between items-center mb-8">
            <div className="flex gap-4">
              ...
              <div className="bg-white/95 backdrop-blur-xl px-6 py-3 rounded-2xl shadow-lg border border-white/20">
                ...
                <div className="text-2xl font-bold text-slate-700">{answeredCount}</div>
              </div>
            </div>
            
            <div className={`px-6 py-3 rounded-2xl shadow-lg flex items-center gap-3 backdrop-blur-xl border ${
              timeLeft <= 10 
                ? 'bg-red-500/95 border-red-400/50 animate-pulse' 
                : 'bg-white/95 border-white/20'
            }`}>
              <Clock className={`w-5 h-5 ${timeLeft <= 10 ? 'text-white' : 'text-slate-600'}`} />
              <span className={`font-bold text-2xl ${timeLeft <= 10 ? 'text-white' : 'text-slate-700'}`}>
                {timeLeft}
              </span>
            </div>
          </div>
